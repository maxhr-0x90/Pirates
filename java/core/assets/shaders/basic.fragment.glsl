...
void main() {
    ...
    vec4 diffuse = texture2D(u_diffuseTexture, mod(v_diffuseUV, 1.0)) * u_diffuseColor * v_color;
    #elif defined(diffuseTextureFlag) && defined(diffuseColorFlag)
    vec4 diffuse = texture2D(u_diffuseTexture, mod(v_diffuseUV, 1.0)) * u_diffuseColor;
    #elif defined(diffuseTextureFlag) && defined(colorFlag)
    vec4 diffuse = texture2D(u_diffuseTexture, mod(v_diffuseUV, 1.0)) * v_color;
    #elif defined(diffuseTextureFlag)
    vec4 diffuse = texture2D(u_diffuseTexture, mod(v_diffuseUV, 1.0));
